...
import psycopg2
# Local Path
# /home/CS4224_Cassandra/project_files/data_files/
...
FROM '/home/stuproj/cs4224p/project_files/data_files/item.csv' 
DELIMITER ','
""")
...
FROM '/home/stuproj/cs4224p/project_files/data_files/warehouse.csv' 
DELIMITER ','
""")
...
FROM '/home/stuproj/cs4224p/project_files/data_files/district.csv' 
DELIMITER ','
""")
...
FROM '/home/stuproj/cs4224p/project_files/data_files/customer.csv' 
DELIMITER ','
""")
...
FROM '/home/stuproj/cs4224p/project_files/data_files/order1.csv' 
DELIMITER ','
""")
...
FROM '/home/stuproj/cs4224p/project_files/data_files/order-line1.csv' 
DELIMITER ','
""")
...
FROM '/home/stuproj/cs4224p/project_files/data_files/stock.csv' 
DELIMITER ','
""")
...
FROM '/home/stuproj/cs4224p/project_files/data_files/xact8.csv' 
DELIMITER ','
""")
